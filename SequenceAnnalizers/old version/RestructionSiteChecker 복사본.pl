...
sub usage{
    ...
    print "	-j	-> just test given random sequence in this file and make Primers\n";
...
# Never mind this one.
# my $JustForTest = "AAT ACC ATG GAA CAT ATG NNY GND RMA VNS GND VHG RAD GND VHG NBB SWG RMA VNS VHG VNS NBB DHT SWG SWG SWG SWG VHG RMA NNY GNR RAD SWG NBB NNY VNS NNK DHT RAD VHG SWG VHG GNR GNR RMA GNY VNS NBB SWG SRY GNR GTG AGC GTT GGT GCG GAA GGC GTG NNY GNR VNS GND DHT NNY RMA GNY DHT GNY GND VHG DHT SWG VHG VHG GND VNS VNS VNS DHT VNS SWG VNS DHT DHT RAD NNK VNS SWG NBB SWG RAD VHG DHT DHT GNR NNY RAD WNY VNS NNY SWG NNY RMA GAA TTC AAG CTT ATA aag gag gaa taa tcc atg gat ggg aat tca rrt vhk twy rns vaw tgg mwg vhk rns rrs ggt ccg vmw agc ggt cgt cca ccg cct rns ggt vhk smw rrs ggt rrt vhk twy rns vaw tgg ctg vhk rns rrs ggt ccg vmw agt ggt cgc ccg cca ccg rns ggt vhk smw rrs ggt rrt vhk twy rns vaw tgg mwg vhk rns rrs ggt ccg vmw tct ggt cgt cct ccg cca rns ggt vhk smw rrs ggt rrt vhk twy rns vaw tgg ctg vhk rns rrs ggt ccg vmw agc gga cgt ccg cct ccg rns gga tcc ggt ggt tca tct gga";
...
$LinkerSeq =~ tr/a-z/A-Z/; #$LinkerSeq = uc $LinkerSeq;			# Capitalize
